...
<html>
<head>
	<title>Findine|deletefoodcategory</title>
			...
			<div class='col-md-6'> 
				...
				include_once "finapjtconn.php";
                   if(isset($_POST['submit'])){
                   	...
                   	$output=$obj->deleteFoodCategory($_GET['catid']);
				...
				?>
				<h3>Are you sure you want to delete <?php if(isset($_GET['catname'])){
					echo "<div style='font-size:35px'>".$_GET['catname']."</div>";
				} ?> from the category list</h3>
